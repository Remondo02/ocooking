<?php
 ...
 function ocooking_admin_page()
 {
     ...
     add_menu_page(
         ...
         'ocooking_settings_admin_page', // callback
     ...
     add_submenu_page(
         ...
         __( 'Liens des réseaux sociaux', OCOOKING_PLUGIN_TEXT_DOMAIN ), // page title
         __( 'Liens des réseaux sociaux', OCOOKING_PLUGIN_TEXT_DOMAIN ), // menu title
         'manage_options', // capability
         'ocooking-settings-social-networks', // slug
         'ocooking_settings_social_networks_admin_page' // callback
     );
 }

 function ocooking_settings_admin_page()
 {
